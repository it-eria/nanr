...
gulp.task('server:start', function() {
      ...
      // browserSync.watch([paths.watch.scss, paths.watch.mustache, paths.watch.dataFile, paths.watch.js, paths.watch.fonts, paths.watch.img]).on('change', browserSync.reload);
});
